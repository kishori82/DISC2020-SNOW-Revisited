...
coordinator, which in a real system would eventually become bottle-necked and restrict scaling to arbitrary sizes.
...
Can one design a coordinator that can scale to arbitrary throughput?
}